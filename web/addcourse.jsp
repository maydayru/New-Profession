...
<head>
    ...
    <title>Добавление курса - Дополнительное образование</title>
    <!-- Bootstrap Core CSS -->
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
            <div class="top-left-part"><a class="logo" href="/index.jsp"><b><img src="/resources/plugins/images/eliteadmin-logo.png" alt="home" /></b><span class="hidden-xs"><strong>Доп</strong>образование</span></a></div>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li> <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-bars p-r-10"></i> <span class="hide-menu"> Курсы <span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level">
                        ...
                        <li> <a href="add-course.html">Добавить курс</a> </li>
        ...
        <div class="container-fluid">
            <div class="row bg-title">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h4 class="page-title">Добавление нового курса</h4> </div>
                <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    <ol class="breadcrumb">
                        <li><a href="/index.jsp">Допобразование</a></li>
                        <li class="active">Добавление курса</li>
                    </ol>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <jsp:include page="/ShowMeDirectionList" />
                <jsp:include page="/ShowMeLecturerList" />
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title">Детали курса</h3>
                        <form action="AddNewCourse" method="post" class="form-material form-horizontal">
                            <div class="form-group">
                                <label class="col-md-12" for="example-text">Название курса</label>
                                <div class="col-md-12">
                                    <input type="text" id="example-text" name="fcoursename" class="form-control" placeholder="Введите название курса">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12" for="duration">Длительность курса</label>
                                <div class="col-md-12">
                                    <input type="text" id="duration" name="fcourseduration" class="form-control" placeholder="Введите продолжительность курса">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12" for="price">Стоимость курса</label>
                                <div class="col-md-12">
                                    <input type="text" id="price" name="fcourseprice" class="form-control" placeholder="Введите стоимость курса">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Преподаватель курса</label>
                                <div class="col-md-12">
                                    <%--замути комбокс для выбора препода--%>
                                        <select class="form-control" name="fcourselecturer">
                                            <c:forEach items="${FLecturers}" var="lecturer">
                                                <option value=<c:out value="${lecturer.lecturer_id}" />><c:out value="${lecturer.lecturer_name}" /></option>
                                            </c:forEach>
                                        </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <%--замути тут выбор уровня образования--%>
                                <label class="col-sm-12">Уровень образования</label>
                                <div class="col-sm-12">
                                    <select class="form-control" name="fcoursedirection">
                                        <c:forEach items="${FDirections}" var="direction">
                                            <option value=<c:out value="${direction.direction_id}" />><c:out value="${direction.direction_name}" /></option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Описание курса</label>
                                <div class="col-md-12">
                                    <textarea class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-info waves-effect waves-light m-r-10">Добавить</button>
                        </form>
                    </div>
                </div>
            </div>
